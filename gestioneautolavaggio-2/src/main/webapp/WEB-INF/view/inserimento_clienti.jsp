...
<center>
	...
	<h3>Compila i seguenti campi:</h3>
    	<form action="/ins_clienti" method="post">
        	<input type=text name=nomeCliente required placeholder="Nome cliente..." style="width: 40%; border-radius: 5px; border-color: blue;"><br>
            <input type=text name=cognomeCliente required placeholder="Cognome cliente..." style="width: 40%; border-radius: 5px; border-color: blue;"><br>
            <input type=text name=cfCliente required placeholder="Codice Fiscale..." style="width: 40%; border-radius: 5px; border-color: blue;"><br>
            <input type=text name=telefonoCliente required placeholder="Cellulare..." style="width: 40%; border-radius: 5px; border-color: blue;"><br><br>
