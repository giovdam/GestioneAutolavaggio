...
<h1>Registrazione Veicoli</h1>
        ...
        <form action="/registrazioneVeicoli" method="post">
            <input type=text name=nTelaio required placeholder="Numero Telaio..." style="width: 40%; border-radius: 5px; border-color: blue;"><br>
            <input type=text name=targa required placeholder="Targa..." style="width: 40%; border-radius: 5px; border-color: blue;"><br>
            <input type=text name=cfCliente required placeholder="Codice Fiscale cliente..." style="width: 40%; border-radius: 5px; border-color: blue;"><br>
