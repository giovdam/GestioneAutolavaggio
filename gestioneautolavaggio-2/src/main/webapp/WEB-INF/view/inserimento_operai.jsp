...
<center>
<h1>Registrazione Operai</h1>
<h3>Compila i seguenti campi</h3>
	<form action="/registrazione_operai" method="post">
		<input type=text name=nomeOperaio required placeholder="Nome operatore..."style="width: 40%; border-radius: 5px; border-color: blue;"><br>
        <input type=text name=cognomeOperaio required placeholder="Cognome operatore..."style="width: 40%; border-radius: 5px; border-color: blue;"><br>
        <input type=text name=cfOperaio required placeholder="Codice Fiscale..."style="width: 40%; border-radius: 5px; border-color: blue;"><br><br>
